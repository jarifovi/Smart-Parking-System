    ...
    <div class="row w-100 justify-content-center">
        <div class="col-md-5 col-lg-4">
            <div class="text-center mb-4">
                ...
                <p class="text-secondary small">We'll help you get back into your account</p>
            </div>
            <div class="card">
                <div class="card-body p-4 p-md-5">
                    <h4 class="mb-4 text-center fw-bold">Forgot Password</h4>
                    ...
                    <div class="mt-4 text-center small text-secondary">
                        Remember your password? <a href="auth_login.php" class="text-accent fw-bold text-decoration-none">Sign In</a>
                    </div>
                </div>
            </div>
            <div class="mt-5 text-center text-secondary small">
                <p>&copy; <?php echo date('Y'); ?> Smart Parking System. <br> Security First.</p>
            </div>
        </div>
    </div>
</div>
